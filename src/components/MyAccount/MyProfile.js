...
import DeleteDialog from "../AccountSettings/AccountDeleteDialog";
import PasswordChange from "../AccountSettings/AccountChangePassword";
...
class MyProfile extends React.Component {
  ...
  handleDataUpdate = () => {
    ...
    let numberValidF = number.charAt(0) === "+";
          ...
          <Card className={classes.card}>
            ...
            <CardActions className="SignUpCardGridCardAction">
              ...
              {passwordDialog ? (
                <DeleteDialog
                  open={passwordDialog}
                  handlePasswordDialog={this.handlePasswordDialog}
                />
              ) : null}
              {passwordChange ? (
                <PasswordChange
